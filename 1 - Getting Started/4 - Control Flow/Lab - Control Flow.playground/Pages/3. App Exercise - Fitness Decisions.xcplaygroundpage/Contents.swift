...
var steps = 1500
let stepsGoal = 10000
if(steps <= stepsGoal/2){print("You're almost halfway there!")}
else if (steps > stepsGoal/2) {print("You're over halfway there!")}
...
if(steps < stepsGoal/10){print("Way to get a good start today!")}
else if (steps <= stepsGoal/2){print("You're almost halfway there!")}
else if (steps > stepsGoal/2) {print("You're over halfway there!")}
/*:
