...
if namesInCaps.lowercased() == name.lowercased(){
    print("\(namesInCaps.lowercased()) and \(name.lowercased()) are the same.")
}
else {
    print("\(namesInCaps.lowercased()) and \(name.lowercased()) are not the same.")
}
